// file: dijkstra.cpp
// Compile: g++ dijkstra.cpp -o dijkstra
// Usage: n, adjacency matrix of weights (use -1 for no edge). Then source vertex (0-based).
#include <iostream>
#include <climits>
using namespace std;
